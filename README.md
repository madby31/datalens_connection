...
Начинаем с самого начала. Откройте [Datalens](https://datalens.yandex.ru).
...
Баскет готов. Нажимаем на наш баскет.

![image](pic/156.png)

Перетаскиваем в баскет наш csv, архивированный zip.
