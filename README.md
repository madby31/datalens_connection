 ...
 * [Загрузка CSV через Yandex Cloud](#загрузка-csv-через-yandex-cloud)
    ...
    + [Варианты применения](#варианты-применения)
        - [Простая загрузка через Python](#простая-загрузка-через-python)
        - [Файловые менеджеры для Windows и Mac](#файловые-менеджеры-для-windows-и-mac)
        - [Еще больше подключений к Object Storage](#еще-больше-подключений-к-object-storage)
...
![browser](https://user-images.githubusercontent.com/41211955/206130505-556fcf15-94ef-4ab5-a521-3b61661c185a.png)

[CyberDuck](https://cloud.yandex.ru/docs/storage/tools/cyberduck)

![winscp-скачать-1024x654](https://user-images.githubusercontent.com/41211955/206131221-f269208e-5d5a-46d4-80f0-d84be5db0cdc.png)

[WinSCP](https://cloud.yandex.ru/docs/storage/tools/winscp)

#### Еще больше подключений к Object Storage

Все подключения описаны на странице документации [Object Storage](https://cloud.yandex.ru/docs/storage/tools/).
